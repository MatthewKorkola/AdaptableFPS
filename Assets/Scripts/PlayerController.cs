...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        if (!UIController.instance.pauseScreen.activeInHierarchy && !GameManager.instance.levelEnding)
        {
            ...
            // Creating a new vector that only considers X and Z components of moveInput.
            Vector3 horizontalMoveInput = new Vector3(moveInput.x, 0, moveInput.z);

            // Animation
            anim.SetFloat("moveSpeed", horizontalMoveInput.magnitude);
        }
    }
